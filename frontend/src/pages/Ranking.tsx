...
const Ranking = () => {
  ...
  return (
    <div className="container mx-auto px-4 py-8 pt-16">
      <div className="mb-8">
        <h1 className="text-3xl font-bold mt-24 mb-4">플레이어 랭킹</h1>
        <p className="text-text-muted mb-6">
          풀을 선택해서 해당 풀의 플레이어 랭킹을 확인해보세요.
        </p>
            ...
            <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-6">
              {pools.map((pool) => (
                <div key={pool.poolId} className="relative">
                  ...
                  />
                  <div className="absolute top-4 right-16 bg-purple-500 text-white text-xs px-2 py-1 rounded-full">
                    랭킹 보기
                  </div>
                </div>
              ))}
